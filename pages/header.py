...
class Header(BasePage):
    ...
    async def close_navigation_menu(self) -> None:
    ...
    async def click_all_items_option(self) -> None:
    ...
    async def click_about_option(self) -> None:
    ...
    async def click_log_out_option(self) -> None:
    ...
    async def click_reset_app_option(self) -> None:
    ...
    async def click_cart_icon(self) -> None:
    ...
    async def check_products_amount_in_the_cart(
            self,
            data: int,
    ) -> bool:
    ...
    async def check_products_amount_in_the_cart_is_not_visible(
            self,
    ) -> bool:
    ...
    async def check_is_navigation_open(
            self,
            data: bool,
    ) -> bool:
